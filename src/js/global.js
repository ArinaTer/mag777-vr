...
export function global() {
  ...
  document.addEventListener("click", (e) => {
    ...
    if (document.querySelector(".footer__form .iti__flag-container")?.classList.contains("block-scroll")) {
      document.querySelector(".footer__form .iti__flag-container").classList.remove("block-scroll");
      gsapOBserver.enable();
    } else if (target.closest(".footer__form .iti__flag-container")) {
      target.closest(".footer__form .iti__flag-container").classList.add("block-scroll");
      gsapOBserver.kill();
    }
  });
